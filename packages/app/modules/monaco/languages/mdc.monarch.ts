import { defineMonarch } from '../composable/define-language'

export default defineMonarch({
    defaultToken: '',
    tokenPostfix: '.md',
        ...
        component: [
            ...
            [
                ...
                [
                    ...
                    'entity.other.attribute-name',
                    'keyword',
                    { token: 'string', nextEmbedded: 'javascript', next: 'componentAttributes' },
                    'string',
                    'string',
                ],
            ],
            // code in the body
            [/./, { token: '@rematch', nextEmbedded: 'javascript', next: 'componentBody' }],
        ],
